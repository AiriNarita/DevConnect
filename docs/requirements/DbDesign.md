...
|-----------------|---------------|------------|-------------|-------------|--------|-------------------------------------------------------------------|
| task_id         | タスクID           | INT        | ⚪︎         |             |        |                                            |
| goal_id         | 目標ID            | INT        |             | ⚪︎         |        | Goalsテーブルを参照する外部キー                                     |
| parent_task_id  | 親タスクID         | INT        |             | ⚪︎         | ○      | 親タスクを参照する外部キー                                |
...
| Column           | Japanese name | Data Type | Primary_key | Foreign_key | Nullable | Description                                          |
|------------------|---------------|-----------|-------------|-------------|----------|------------------------------------------------------|
| task_comment_id  | タスクコメントID     | INT       | ⚪︎         |             |          | 各タスクコメントの一意の識別子                                 |
| task_id          | タスクID           | INT       |             | ⚪︎         |          | Tasksテーブルを参照する外部キー                                |
| user_id          | ユーザーID         | INT       |             | ⚪︎         |          | Usersテーブルを参照する外部キー                                |
